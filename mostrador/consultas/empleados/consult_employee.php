    ...
    <div id="search-box">
        <form action="" method="post">
            <select name="sucursal" id="sucursalA">
                <option value="todas" <?php echo ($_SESSION['sucursalA'] === 'todas') ? 'selected' : ''; ?>>Todas las
                    sucursales</option>
                <option value="1" <?php echo ($_SESSION['sucursalA'] === '1') ? 'selected' : ''; ?>>Roma</option>
                <option value="2" <?php echo ($_SESSION['sucursalA'] === '2') ? 'selected' : ''; ?>>Chalco</option>
            </select>
        ...
        <form action="" method="post">
            <select name="sucursal" id="sucursalI">
                <option value="todas" <?php echo ($_SESSION['sucursalI'] === 'todas') ? 'selected' : ''; ?>>Todas las
                    sucursales</option>
                <option value="1" <?php echo ($_SESSION['sucursalI'] === '1') ? 'selected' : ''; ?>>Roma</option>
                <option value="2" <?php echo ($_SESSION['sucursalI'] === '2') ? 'selected' : ''; ?>>Chalco</option>
            </select>
